...
--  Unit Name           : UIF_Oeu_Simu.Dpm
--  Unit Type           : Package body
--  Copyright           : GMV
--  Classification      :
--  Date                : $Date: 2011/11/25 06:55:06 $
--  Revision            : $Revision: 1.21 $
--  Function            :  Builder of DPM User Interface
-- ****************************************************************************
...
package body UIF_Oeu_Simu.Dpm is
      ...
      Gtk.Box.Pack_Start
        ...
        Wdgt_Image_Title.Gtk_New (
          ...
          Image         => Gtk.Image.Gtk_Image_New_From_Pixbuf
            (Wdgt_Images.Get_Image_Xpm (Wdgt_Images.Cartoon_Dpm)),
          Title         => " DPM ", --& ASCII.LF & "controls",
          Title_Pos     => Gtk.Enums.Pos_Right,
          Title_Color   => Wdgt_Colors.Dpm_1,
          Frame_Shadow  => Gtk.Enums.Shadow_None);-- Shadow_Etched_In);
        
      Title.Set_Tooltip_Text ("DPM: OEU Digital Processing Module. " & ASCII.LF &
        "It processes all video streams");
...
-- TODO: Use Config button
      ...
      Gtk.Box.Pack_Start
        ...
        Wdgt_Log.Gtk_New 
          (Title            => "DPM simulation execution log:", 
