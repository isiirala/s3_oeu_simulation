...
package body Uif_Tc_Tm_130 is

   subtype Notebook_Id_T is Glib.Gint range 0 .. 1;
   -- 2 Notebook pages:
   --      0 => TC(130,128)
   --      1 => TC(130,129)     TM(130,130)
   ...
   Page_Config_C       : constant Page_Config_T                 :=
     (0 => (Basic_Types_1553.Tc_130_128,    Basic_Types_1553.Tc_Tm_None),
      1 => (Basic_Types_1553.Tc_130_129,    Basic_Types_1553.Tm_130_130));
