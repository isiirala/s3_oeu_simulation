...
package body Uif_Tc_Tm_17 is

   subtype Notebook_Id_T is Glib.Gint range 0 .. 0;
   -- 1 Notebook pages:
   --      0 => TC(17,1)     TM(17,2)
   ...
   Page_Config_C       : constant Page_Config_T                 :=
     (0 => (Basic_Types_1553.Tc_17_1,    Basic_Types_1553.Tm_17_2));
...
-- --------------------------------------------------------------------------------------
   ...
   begin
      ...
      Tc_Id := Basic_Types_1553.Tc_17_1;
      Tm_Id := Basic_Types_1553.Tm_17_2;
